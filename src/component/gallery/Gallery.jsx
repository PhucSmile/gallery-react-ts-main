                    ...
                    <Col lg={5}>
                        <div className="gallery__wrap">
                            ...
                            <Carousel responsive={responsive}>
                                <div
                                    className="img__item"
                                    onMouseEnter={() => setPreviewImg(data.img01)}
                                ...
                                <div
                                    className="img__item"
                                    onMouseEnter={() => setPreviewImg(data.img02)}
                                    onClick={HandleShowtoggle}
                                >
                                ...
                                <div
                                    className="img__item"
                                    onMouseEnter={() => setPreviewImg(data.img03)}
                                    onClick={HandleShowtoggle}
                                >
                                ...
                                <div
                                    className="img__item"
                                    onMouseEnter={() => setPreviewImg(data.img04)}
                                    onClick={HandleShowtoggle}
                                >
                                ...
                                <div
                                    className="img__item"
                                    onMouseEnter={() => setPreviewImg(data.img05)}
                                    onClick={HandleShowtoggle}
                                >
                                ...
                                <div
                                    className="img__item"
                                    onMouseEnter={() => setPreviewImg(data.img06)}
                                    onClick={HandleShowtoggle}
                                >
                                    <img src={data.img05} alt="gallery-img" />
                                </div>
